	  ...
	  <div class="col-12">
		<div class="card">
		  <div class="card-header">
		  	<h3 style="float: left;">Issue List</h3>
			 ...
			 <!--  <a type="button" href="<?php echo base_url();?>agent/hired" class="btn btn-info float"> Hired Agent</a> 
  			...
  			<!-- <button type="button" class="btn btn-info float-right" data-toggle="modal" data-target="#myModal">HELLO</button>
 -->
		...
		<?php endif;?>
		  ...
		  <div class="card-body table-responsive p-0" style="height: 300px;">
			<table class="table table-head-fixed text-nowrap">
			  ...
			  <tbody>
				 <?php foreach($issue as $val){?>
				<tr>
				<td><?php echo $val->title;?></td>
				<td style="color: red;"><?php echo $val->issues;?></td>
				</tr>
				<?php }?>
			  </tbody>
			</table>
